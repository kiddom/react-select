...
var _smbReactSelection = require('smb-react-selection');

var _smbReactSelection2 = _interopRequireDefault(_smbReactSelection);
...
},{"./components/BooleanSelect":2,"./components/Contributors":3,"./components/Creatable":4,"./components/CustomComponents":5,"./components/CustomRender":6,"./components/GithubUsers":7,"./components/MultiSelectWithDifferentLabel":8,"./components/Multiselect":9,"./components/NumericSelect":10,"./components/States":11,"./components/Virtualized":12,"react":undefined,"react-dom":undefined,"smb-react-selection":undefined}],2:[function(require,module,exports){
'use strict';
...
var ValuesAsBooleansField = _react2['default'].createClass({
	...
	render: function render() {
		...
		return _react2['default'].createElement(
			...
			_react2['default'].createElement(_smbReactSelection2['default'], {
...
},{"react":undefined,"smb-react-selection":undefined}],3:[function(require,module,exports){
'use strict';
...
var Contributors = _react2['default'].createClass({
	...
	render: function render() {
		return _react2['default'].createElement(
			...
			_react2['default'].createElement(_smbReactSelection2['default'].Async, { multi: this.state.multi, value: this.state.value, onChange: this.onChange, onValueClick: this.gotoContributor, valueKey: 'github', labelKey: 'name', loadOptions: this.getContributors }),
			_react2['default'].createElement(
				'div',
				{ className: 'checkbox-list' },
				_react2['default'].createElement(
...
},{"../data/contributors":14,"react":undefined,"smb-react-selection":undefined}],4:[function(require,module,exports){
'use strict';
...
var CreatableDemo = _react2['default'].createClass({
	...
	render: function render() {
		...
		return _react2['default'].createElement(
			...
			_react2['default'].createElement(_smbReactSelection2['default'].Creatable, {
				multi: multi,
				options: options,
...
},{"react":undefined,"smb-react-selection":undefined}],5:[function(require,module,exports){
'use strict';
...
},{"../data/users":16,"react":undefined,"react-gravatar":21,"smb-react-selection":undefined}],6:[function(require,module,exports){
'use strict';
...
},{"react":undefined,"react-highlight-words":30,"smb-react-selection":undefined}],7:[function(require,module,exports){
'use strict';
...
var GithubUsers = _react2['default'].createClass({
	...
	render: function render() {
		var AsyncComponent = this.state.creatable ? _smbReactSelection2['default'].AsyncCreatable : _smbReactSelection2['default'].Async;
...
},{"isomorphic-fetch":17,"react":undefined,"smb-react-selection":undefined}],8:[function(require,module,exports){
'use strict';
...
var MultiSelectWithDifferentLabel = _react2['default'].createClass({
	...
	render: function render() {
		...
		return _react2['default'].createElement(
			...
			_react2['default'].createElement(_smbReactSelection2['default'], { multi: true, simpleValue: true, disabled: this.state.disabled, value: this.state.value, placeholder: 'Select your favourite(s)', options: this.state.options, onChange: this.handleSelectChange, showSelectedCount: true, valueRenderer: function () {
...
},{"react":undefined,"smb-react-selection":undefined}],9:[function(require,module,exports){
'use strict';
...
var MultiSelectField = _react2['default'].createClass({
	...
	render: function render() {
		return _react2['default'].createElement(
			...
			_react2['default'].createElement(_smbReactSelection2['default'], { multi: true, simpleValue: true, disabled: this.state.disabled, value: this.state.value, placeholder: 'Select your favourite(s)', options: this.state.options, onChange: this.handleSelectChange }),
			_react2['default'].createElement(
				'div',
				{ className: 'checkbox-list' },
				_react2['default'].createElement(
...
},{"react":undefined,"smb-react-selection":undefined}],10:[function(require,module,exports){
'use strict';
...
},{"react":undefined,"smb-react-selection":undefined}],11:[function(require,module,exports){
'use strict';
...
var StatesField = _react2['default'].createClass({
	...
	render: function render() {
		...
		return _react2['default'].createElement(
			...
			_react2['default'].createElement(_smbReactSelection2['default'], { ref: 'stateSelect', autofocus: true, options: options, simpleValue: true, clearable: this.state.clearable, name: 'selected-state', disabled: this.state.disabled, value: this.state.selectValue, onChange: this.updateValue, searchable: this.state.searchable }),
			_react2['default'].createElement(
				'div',
				{ style: { marginTop: 14 } },
				_react2['default'].createElement(
...
},{"../data/states":15,"react":undefined,"smb-react-selection":undefined}],12:[function(require,module,exports){
'use strict';
